...
We went to the Atkinson Lot and many different atm machines and saw how they were designed and how they worked. That motivated us to google search what kind of layout
were being used on those systems. Finally we found it was similar to the CardLayout compared to any of the other ones from java swing and then we decided that our main
panel will be of Card Layout so that we can switch back and forth between pages.
